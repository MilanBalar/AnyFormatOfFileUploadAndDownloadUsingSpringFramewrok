...
public class AppController {
	...
	public String downloadDocument(@PathVariable int userId, @PathVariable int docId, HttpServletResponse response)
		...
		response.setHeader("Content-Disposition", String.format("attachment; filename=\"" + document.getName() + "\""));
		/*----------for open file in browser-------------*/
        //response.setHeader("Content-Disposition", String.format("inline; filename=\"" + document2.getName() + "\""));
		/*---------------------------*/
